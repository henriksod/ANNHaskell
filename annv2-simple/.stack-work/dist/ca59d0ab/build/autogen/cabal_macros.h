...
/* package annv2-0.1.0.0 */
#define VERSION_annv2 "0.1.0.0"
#define MIN_VERSION_annv2(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "annv2-0.1.0.0"

#define CURRENT_PACKAGE_KEY "annv2-0.1.0.0"
